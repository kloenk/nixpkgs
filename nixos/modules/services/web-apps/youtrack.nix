...
in
{
  ...
  config = lib.mkIf cfg.enable {
    warnings = lib.optional (lib.versions.major package.version <= "2022")
    ...
    ++ lib.optional (cfg.extraParams != "" && (lib.versions.major package.version >= "2023"))
    ...
    ++ lib.optional (cfg.jvmOpts != "" && (lib.versions.major package.version >= "2023"))
    ...
    services.youtrack.generalParameters = lib.optional (lib.versions.major package.version >= "2023")
    ...
    systemd.services.youtrack = let
      ...
      in {
        ...
        serviceConfig = {
          ...
          Group = "youtrack";
          Restart = "on-failure";
          ExecStart = ''${package}/bin/youtrack ${cfg.jvmOpts} ${cfg.environmentalParameters.listen-address}:${toString cfg.environmentalParameters.listen-port}'';
        };
      };
      service_zip = let
      ...
      in {
        ...
        '' + lib.optionalString (lib.versionAtLeast package.version "2023.3") ''
    ...
    in if (lib.versions.major package.version >= "2023") then service_zip else service_jar;
